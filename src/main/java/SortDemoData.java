...
public class SortDemoData  {
         ...
         * 
         * Description: Reads numbers in from an input String to store in myArray; Removes duplicates.
         * Throws NumberFormatException if input is not an integer.
         * Throws NoSuchElementException if there are no numbers in the input string.
         * Throws NegativeArraySizeException if negative number provided for array size.
         */
